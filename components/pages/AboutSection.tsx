  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-start justify-center px-10 md:px-48 py-20 md:py-32">
        {/* Main Heading */}
        <h2
          className="text-[28px] md:text-[44px] font-medium leading-8 md:leading-12 text-white max-w-[271px] md:max-w-[437px] mb-16 md:mb-24"
          style={{ fontFamily: "MADETOMMY, system-ui, sans-serif" }}
        >
          Sylvorn Labs is a software innovation studio crafting intuitive,
        ...
        <div className="flex flex-col gap-20 md:gap-0 md:flex-row md:justify-between w-full">
          ...
          <div className="flex flex-col gap-8 md:gap-16 max-w-[308px] md:max-w-[434px]">
            <p
              className="text-sm md:text-xl font-normal leading-[18px] md:leading-7 text-white"
              style={{ fontFamily: "MADETOMMY, system-ui, sans-serif" }}
            >
              Sylvorn Labs builds intuitive, scalable software for today&apos;s
              evolving digital landscape — delivering future-ready solutions
              with clarity, efficiency, and reliable performance.
            </p>

            <p
              className="text-sm md:text-xl font-normal leading-[18px] md:leading-7 text-white max-w-[234px] md:max-w-[335px]"
              style={{ fontFamily: "MADETOMMY, system-ui, sans-serif" }}
            >
              Sylvorn&apos;s adaptive architecture ensures best-in-class results
